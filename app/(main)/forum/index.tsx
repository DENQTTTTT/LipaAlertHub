// app/(main)/forum/index.tsx - Final fix for Timestamp handling
...
import { ForumPost, getForumPosts } from "../../../services/forum";
...
const ForumIndex = () => {
  ...
  // Enhanced date formatting function that handles all cases
  ...
  const handlePostPress = (postId: string) => {
    router.push(`/(main)/forum/post?id=${postId}`);
  };
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyText}>
        Be the first to start a discussion in our community forum! Share your thoughts, ask questions, or start meaningful conversations.
      </Text>
